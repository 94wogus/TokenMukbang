...
| OAuth API | `UsageFetching` | `ClaudeAPIClient` |
...
- `Sources/TokenMukbangKit/Support/ProcessRunner.swift`, `Keychain/`, `API/`, `Sessions/`,
  `Focus/`, `UsageService.swift`, `Support/FileWatcher.swift`(`FileWatching` seam, ADR-0014)
